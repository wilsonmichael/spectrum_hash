...
class SpectrumHash
  ...
  def new(spectrum, spectrum_type, version=nil)
  ...
  #
  def splash
    @splash ||= version_block + top_peaks_block + full_spectrum_block + similarity_block
  end
  ...
  def similarity_block_peaks
    spectrum_sorted_for_top_peaks[SIMILARITY_BLOCK_MAX_PEAKS]
  end
